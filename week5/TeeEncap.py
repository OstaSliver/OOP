...
def search_enrollment_subject_student(subject, student):
    for enroll in enrollment_list:
        if enroll.subject.subject_id == subject.subject_id and enroll.student.student_id == student.student_id:
            return enroll
...
def get_student_record(student):
    student_record = {}
    for enroll in enrollment_list:
        if enroll.student.student_id == student.student_id:
            student_record[enroll.subject.subject_id] = [enroll.subject.subject_name, enroll.grade]
...
def get_student_GPS(student):
    ...
    for enroll in enrollment_list:
        if enroll.student.student_id == student.student_id:
            sum_p += grade_to_count(enroll.subject.grade) * enroll.subject.credit
            sum_c += enroll.subject.credit
    return sum_p/sum_c
